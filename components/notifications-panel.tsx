...
export default function NotificationsPanel({ onClose, onMarkAllAsRead }: NotificationsPanelProps) {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        // Note: Authentication has been removed. Implement proper auth handling in production.
        ...
        const transformedNotifications = data.map((req: any) => ({
          ...
          request: req,
          isRead: false // Note: Authentication has been removed. Implement proper auth handling in production.
        }))
